...
export const AGENT_HELP_ENTRIES: readonly AgentHelpEntry[] = [
  ...
  { command: 'leave', group: 'identity', line: 'leave — deregister from one swarm' },
  { command: 'use', group: 'identity', line: 'use — pick the default swarm here' },
  ...
  { command: 'spawn', group: 'identity', line: 'spawn --split | --new-workspace <name> — opus default' },
